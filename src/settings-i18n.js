...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      remindersTitle: "提醒",
      remindersSubtitle: "在桌面上创建简单提醒。即使应用还在后台运行，Clawd 也会在到点时提醒你。",
      remindersSectionNew: "新提醒",
      remindersSectionList: "提醒列表",
      remindersAddTitle: "添加提醒",
      remindersEditTitle: "编辑提醒",
      remindersTitleLabel: "标题",
      remindersTitlePlaceholder: "例如：喝水",
      remindersWhenLabel: "时间",
      remindersNoteLabel: "备注",
      remindersNotePlaceholder: "可选备注",
      remindersAdd: "添加提醒",
      remindersSave: "保存提醒",
      remindersCancel: "取消",
      remindersEmpty: "还没有提醒，先在上面添加一个。",
      remindersEdit: "编辑",
      remindersDelete: "删除",
      remindersDeleteConfirm: "删除提醒“{title}”？此操作无法撤销。",
      remindersMarkDone: "完成",
      remindersMarkActive: "重新启用",
      remindersSnooze10m: "延后 10 分钟",
      remindersStatusDone: "已完成",
      remindersStatusUpcoming: "待提醒",
      remindersStatusOverdue: "已超时",
      remindersAdded: "提醒已添加。",
      remindersUpdated: "提醒已保存。",
      remindersErrorMissingTitle: "请先填写提醒标题。",
      remindersErrorMissingWhen: "请先选择提醒时间。",
      healthReminderSectionTitle: "健康提醒",
      healthReminderEnabledLabel: "一键健康提醒",
      healthReminderEnabledDesc: "开启后，Clawd 会在每个小时的第 50 分钟提醒你起来走一下、喝点水。",
      appleCalendarSectionTitle: "Apple Calendar sync",
      appleCalendarStatusLabel: "Sync status",
      appleCalendarStatusLoading: "Checking Apple Calendar…",
      appleCalendarStatusNotConfigured: "Not configured yet.",
      appleCalendarStatusCalendarUnknown: "Unknown calendar",
      appleCalendarStatusNeverSynced: "Never synced",
      appleCalendarStatusError: "Last sync failed: {message}",
      appleCalendarStatusReady: "Connected as {appleId}. Target calendar: {calendar}. Last sync: {lastSync}.",
      appleCalendarCredentialsLabel: "Apple ID and password",
      appleCalendarCredentialsDesc: "Use your Apple ID and an app-specific password to connect iCloud Calendar over CalDAV.",
      appleCalendarAppleIdPlaceholder: "name@example.com",
      appleCalendarAppPasswordPlaceholder: "App-specific password",
      appleCalendarSaveCredentials: "Save credentials",
      appleCalendarSaving: "Saving…",
      appleCalendarClearCredentials: "Clear credentials",
      appleCalendarClearConfirm: "Clear the saved Apple Calendar credentials?",
      appleCalendarCredentialsSaved: "Apple Calendar credentials saved.",
      appleCalendarCredentialsSaveFailed: "Could not save Apple Calendar credentials.",
      appleCalendarAppleIdMissing: "Enter your Apple ID first.",
      appleCalendarAppPasswordMissing: "Enter your app-specific password first.",
      appleCalendarTargetLabel: "Target calendar",
      appleCalendarTargetDesc: "Choose the writable iCloud calendar that Clawd should mirror with reminders.",
      appleCalendarTargetAuto: "Auto-select first writable calendar",
      appleCalendarLoadingCalendars: "Loading calendars…",
      appleCalendarRefreshCalendars: "Refresh calendars",
      appleCalendarRefreshing: "Refreshing…",
      appleCalendarSyncNow: "Sync now",
      appleCalendarSyncing: "Syncing…",
      appleCalendarSyncStarted: "Apple Calendar sync completed.",
      appleCalendarSyncFailed: "Apple Calendar sync failed.",
      appleCalendarSyncEnabledLabel: "Enable Apple Calendar sync",
      appleCalendarSyncEnabledDesc: "When enabled, Clawd keeps reminders and Apple Calendar in sync in both directions.",
      appleCalendarRefreshLabel: "Refresh interval",
      appleCalendarRefreshDesc: "How often Clawd should re-check Apple Calendar, in minutes.",
      appleCalendarWindowDaysLabel: "Sync window",
      appleCalendarWindowDaysDesc: "How many upcoming days of Apple Calendar events Clawd should import into reminders.",
      appleCalendarWindowDaysUnit: "days",
      appleCalendarSyncAllCalendarsLabel: "Sync all calendars",
      appleCalendarSyncAllCalendarsDesc: "When enabled, Clawd reads and refreshes every available Apple Calendar. The target calendar selector is ignored.",
      ...
      rowPetWanderEnabled: "Desktop wandering",
      rowPetWanderEnabledDesc: "When Clawd has been idle for a while, let it slowly wander along the desktop on its own.",
      rowSize: "Size",
    ...
    zh: {
      ...
      healthReminderEnabledLabel: "一键健康提醒",
      healthReminderEnabledDesc: "开启后，Clawd 会在每个小时的第 50 分钟提醒你起来走一下、喝点水。",
      appleCalendarSectionTitle: "Apple Calendar 同步",
      appleCalendarStatusLabel: "同步状态",
      appleCalendarStatusLoading: "正在检查 Apple Calendar…",
      appleCalendarStatusNotConfigured: "尚未配置。",
      appleCalendarStatusCalendarUnknown: "未知日历",
      appleCalendarStatusNeverSynced: "从未同步",
      appleCalendarStatusError: "上次同步失败：{message}",
      appleCalendarStatusReady: "当前登录为 {appleId}。目标日历：{calendar}。上次同步：{lastSync}。",
      appleCalendarCredentialsLabel: "Apple ID 和密码",
      appleCalendarCredentialsDesc: "使用 Apple ID 和应用专用密码，通过 CalDAV 连接 iCloud 日历。",
      appleCalendarAppleIdPlaceholder: "name@example.com",
      appleCalendarAppPasswordPlaceholder: "应用专用密码",
      appleCalendarSaveCredentials: "保存凭据",
      appleCalendarSaving: "保存中…",
      appleCalendarClearCredentials: "清除凭据",
      appleCalendarClearConfirm: "清除已保存的 Apple Calendar 凭据吗？",
      appleCalendarCredentialsSaved: "Apple Calendar 凭据已保存。",
      appleCalendarCredentialsSaveFailed: "无法保存 Apple Calendar 凭据。",
      appleCalendarAppleIdMissing: "请先输入 Apple ID。",
      appleCalendarAppPasswordMissing: "请先输入应用专用密码。",
      appleCalendarTargetLabel: "目标日历",
      appleCalendarTargetDesc: "选择 Clawd 要和提醒双向镜像的可写 iCloud 日历。",
      appleCalendarTargetAuto: "自动选择第一个可写日历",
      appleCalendarLoadingCalendars: "正在加载日历…",
      appleCalendarRefreshCalendars: "刷新日历",
      appleCalendarRefreshing: "刷新中…",
      appleCalendarSyncNow: "立即同步",
      appleCalendarSyncing: "同步中…",
      appleCalendarSyncStarted: "Apple Calendar 同步已完成。",
      appleCalendarSyncFailed: "Apple Calendar 同步失败。",
      appleCalendarSyncEnabledLabel: "启用 Apple Calendar 同步",
      appleCalendarSyncEnabledDesc: "启用后，Clawd 会在提醒和 Apple Calendar 之间做双向同步。",
      appleCalendarRefreshLabel: "刷新频率",
      appleCalendarRefreshDesc: "Clawd 重新检查 Apple Calendar 的间隔，单位为分钟。",
      appleCalendarWindowDaysLabel: "同步天数",
      appleCalendarWindowDaysDesc: "Clawd 要把未来多少天内的 Apple Calendar 日程导入到提醒里。",
      appleCalendarWindowDaysUnit: "天",
      appleCalendarSyncAllCalendarsLabel: "同步所有日历",
      appleCalendarSyncAllCalendarsDesc: "启用后，Clawd 会读取并刷新所有可用的 Apple 日历，目标日历选择将不再限制同步范围。",
      ...
      rowPetWanderEnabled: "桌面游走",
      rowPetWanderEnabledDesc: "Clawd 空闲一段时间后，会自己沿着桌面慢慢走动。",
      rowSize: "大小",
